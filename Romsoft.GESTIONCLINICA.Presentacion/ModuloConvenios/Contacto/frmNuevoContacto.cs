    ...
    public partial class frmNuevoContacto : Form
    {
        ...
        private void GetDatosContacto()
        {
            if (txtId.Text != "0")
            {
                ...
                jsonResponse = InvokeHelper.MakeRequest(ConstantesWindows.WS_CON_CONTACTO_GetById, GetContacto(), ConstantesWindows.METHODPOST);
        ...
        private CON_CONTACTODTO GetContacto()
        {
            ...
            return new CON_CONTACTODTO
            {
                ...
                t_razon_social = TxtRazonSocial.Text.Trim(),
                t_razon_comercial = TxtRazonComercial.Text.Trim(),
                ...
                UsuarioCreacion = "2",        /*WindowsSession.UsuarioActual,*/
                UsuarioModificacion = "2",    /*WindowsSession.UsuarioActual,*/
